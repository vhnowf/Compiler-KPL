...
void compileConstDecl(void) {
  switch(lookAhead->tokenType) {
    case TK_IDENT:
      ...
      eat(SB_SEMICOLON);
      break;
    default: error(ERR_INVALIDCONSTDECL,lookAhead->lineNo, lookAhead->colNo); break;
  }
}
...
void compileTypeDecl(void) {
  ...
  switch(lookAhead->tokenType) {
    case TK_IDENT:
      ...
      eat(SB_SEMICOLON);
      break;
  default: error(ERR_INVALIDTYPEDECL,lookAhead->lineNo, lookAhead->colNo); break;
  }
...
void compileAssignStDouble(void) {
      eat(SB_LPAR);
      eat(TK_IDENT);
      while(lookAhead->tokenType == SB_COMMA){
        eat(SB_COMMA);
...
void compileCondition2(void) {
  ...
  switch(lookAhead->tokenType) {
    ...
    case SB_GT: 
      ...
      compileExpression();
      break;
    default: error(ERR_INVALIDCOMPARATOR, lookAhead->lineNo, lookAhead->colNo); break;
  }
}
...
void compileExpression(void) {
  ...
  switch(lookAhead->tokenType) {
    ...
    case SB_MINUS:
      ...
      compileExpression2();
      break;
    default: compileExpression2(); break;
  }
...
void compileFactor(void) {
  ...
  switch(lookAhead->tokenType) {
    ...
    case SB_LPAR: 
      ...
      break;
    default: 
      error(ERR_INVALIDFACTOR,lookAhead->lineNo, lookAhead->colNo); break;
  } 
}
